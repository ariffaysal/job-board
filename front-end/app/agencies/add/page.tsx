...
export default function AddAgencyPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Logic unchanged, just shortened the URL to use the baseURL from lib/axios
      ...
      <div className="card w-full max-w-lg bg-white shadow-2xl relative z-10 rounded-3xl border-t-8 border-blue-900">
        <div className="card-body p-10">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-4xl font-bold text-gray-900 mb-2">Create New Agency</h1>
            <p className="text-lg text-gray-600">Register a new agency account</p>
          </div>
